...
//    }
    ...
    val mapper = mapOf(
        ...
        "Pallas '08_thebagstore.nl/Wêz Warber en Fluch" to "Pallas '08",
        ...
        "SDO/Onderlinge Verzekeringen Kamerik" to "SDO (K)",
        "SDO/Fiable" to "SDO (K)",
        "SEV" to "SEV (Z)",
        "SKV" to "SKV (S)",
